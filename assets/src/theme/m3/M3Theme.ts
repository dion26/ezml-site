...
export const DEFAULT_M3_THEME_SCHEME: M3ThemeScheme = {
    light: {
        ...
        secondaryContainer: '#b4f493',
        onSecondaryContainer: '#062100',

        tertiary: '#4b57a9',
        onTertiary: '#ffffff',

        tertiaryContainer: '#dfe0ff',
        onTertiaryContainer: '#000d60',
    ...
    dark: {
        ...
        secondaryContainer: '#1b5201',
        onSecondaryContainer: '#b4f493',

        tertiary: '#bbc3ff',
        onTertiary: '#1a2678',

        tertiaryContainer: '#333f90',
